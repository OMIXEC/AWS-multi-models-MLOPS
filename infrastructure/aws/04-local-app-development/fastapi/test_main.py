...
def test_read_root():
    ...
    assert response.json() == {"health": "200", "mode": "hybrid"}
...
def test_get_sentiment_api_v1_query():
    # Tests the exact endpoint the user mentioned: http://127.0.0.1:8502/api/v1/get_sentiment/
...
def test_post_sentiment_analysis():
    # Tests the POST /api/v1/sentiment_analysis endpoint
    payload = {
