...
API_URL = "http://127.0.0.1:8502/api/v1/" # You can set the default 8000 port - i chose 8052
headers = {
  'Content-Type': 'application/json'
}
# Logo
st.image("images/omixec.png", width=150)

# Title
st.title("Omixec Multi-Models - analyze your data")
...
if model=="Sentiment Classifier":
    text = st.text_area("Enter Your Critic Review")
    ...
    text = st.text_area("Enter Your Post Content")
    user_id = st.text_input("Enter user id")
