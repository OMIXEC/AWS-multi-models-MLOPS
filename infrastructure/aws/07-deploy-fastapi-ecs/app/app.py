...
image_proccesor = AutoImageProcessor.from_pretrained(local_path, use_fast=True, local_files_only=True)
pose_model = pipeline('image-classification', model=local_path, device=device, image_proccesor=image_proccesor)
