...
```bash
# Start FastAPI (from infrastructure/gcp/04-local-app-development/fastapi)
...
> Whether the backend loads models from GCS or locally does not affect the frontend.
